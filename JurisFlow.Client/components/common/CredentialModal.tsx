        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden scale-100 animate-in zoom-in-95 duration-200 border border-gray-100">
                <div className="bg-emerald-500 p-6 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2">Staff account created</h3>
                    <p className="text-emerald-50 text-sm">The account was added successfully.</p>
                </div>
                ...
                <div className="p-6 space-y-6">
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-4">
                        ...
                        {tempPassword && (
                            <div className="flex flex-col">
                                <span className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Temporary Password</span>
                                <div className="flex items-center justify-between bg-white p-2 rounded border border-gray-200">
