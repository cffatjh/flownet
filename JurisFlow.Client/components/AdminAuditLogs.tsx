...
export const AdminAuditLogs: React.FC = () => {
  ...
  const load = async (pageToLoad: number, f: Filters) => {
    ...
    try {
      ...
      toast.error(e?.message || 'Unable to load audit logs');
      setData(null);
    } finally {
      setLoading(false);
    }
    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-2">
          <div className="md:col-span-2 relative">
            ...
            <input
              ...
              placeholder="Search: action/entity/details/email/ip..."
      ...
      <div className="p-4 border-t border-gray-200 flex items-center justify-between">
        <div className="text-xs text-gray-500">
          Total: <span className="font-bold text-gray-700">{data?.total ?? 0}</span>
        </div>
        <div className="flex items-center gap-2">
          <button
